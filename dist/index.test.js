...
describe('Test for Room class', () => {
    test("isOccupied es true cuando la habitacion esta ocupada en una fecha dada", () => {
        ...
        const booking1 = new index_1.Booking({
            name: "booking 1",
            email: "bok@bok.es",
            checkin: "2023-10-16",
            checkout: "2023-10-22",
        ...
        const booking2 = new index_1.Booking({
            name: "booking 2",
            email: "bok2@bok.es",
            checkin: "2023-10-23",
            checkout: "2023-10-31",
        ...
        const room1 = new index_1.Room(room_A.name, bookings, room_A.rate, room_A.discount);
    ...
    test("totalOccupancyPercentage debe entregar el porcentage total de ocupación esperado de 75", () => {
        ...
        const booking3 = new index_1.Booking({
            name: "booking 1",
            email: "bok@bok.es",
            checkin: "2023-10-04",
            checkout: "2023-10-09",
        ...
        const booking4 = new index_1.Booking({
            name: "booking 2",
            email: "bok2@bok.es",
            checkin: "2023-10-11",
            checkout: "2023-10-15",
        ...
        const room_1 = new index_1.Room(room_A.name, bookings, room_A.rate, room_A.discount);
        const room_2 = new index_1.Room(room_B.name, bookings2, room_B.rate, room_B.discount);
        const totalOccupPer = index_1.Room.totalOccupancyPercentage([room_1, room_2], '2023-10-01', '2023-10-06');
    ...
    test("totalOccupancyPercentage entrega 0 para un array vacio de rooms", () => {
        const totalOccupPer = index_1.Room.totalOccupancyPercentage([], '2023-10-01', '2023-10-06');
    ...
    test("totalOccupancyPercentage tiene que devolver 0 si las fechas pasadas al metodo están fuera del rango", () => {
        ...
        const percentage = index_1.Room.totalOccupancyPercentage(roomArray, "2023-11-01", "2023-11-15");
    ...
    test("availablRooms tiene que devolver la lista de las habitaciones disponibles para una rango de fechas consultado", () => {
        ...
        const room2 = new index_1.Room(roomB.name, bookingsB, roomB.rate, roomB.discount);
        const roomArray = [room1, room2];
        const availables = index_1.Room.availableRooms(roomArray, "2023-10-16", "2023-10-20");
    ...
    test("availablRooms tiene que devolver vacio para una rango de fechas consultado donde no hay habitaciones libres", () => {
        ...
        const room2 = new index_1.Room(roomB.name, bookingsB, roomB.rate, roomB.discount);
        const roomArray = [room1, room2];
        const availables = index_1.Room.availableRooms(roomArray, "2023-10-08", "2023-10-15");
        expect(availables).toEqual([]);
    });
    test("availablRooms tiene que devolver vacio para array vacio de rooms", () => {
        const availables = index_1.Room.availableRooms([], '2023-10-01', '2023-10-02');
        expect(availables).toEqual([]);
    });
});
